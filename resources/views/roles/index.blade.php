                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                <div class="d-flex flex-column text-gray-600">
                                                    @foreach ($role->permissions as $key => $permission)
                                                        @if ($key < 3)
                                                            <!-- Afficher uniquement les 3 premières permissions -->
                                                    ...
                                                    <!-- Afficher "and more..." si le nombre de permissions est supérieur à 5 -->
                                                    @if ($role->permissions->count() > 3)
                                                        <div class="d-flex align-items-center py-2">
                                                            <span class="bullet bg-primary me-3"></span>
                                                            <em>et {{ $role->permissions->count() - 3 }} plus...</em>
                                                        </div>
                                                    @endif
                                                </div>
                                                <!--end::Permissions-->
                                    ...
                                    <div class="card h-md-100">
                                        ...
                                        <div class="card-body d-flex flex-center">
                                            ...
                                            <button type="button" class="btn btn-clear d-flex flex-column flex-center"
                                                ...
                                                <!--end::Illustration-->
                                                <!--begin::Label-->
                                                <div class="fw-bolder fs-3 text-gray-600 text-hover-primary">Ajouter un
                                                    nouveau Role</div>
                                                <!--end::Label-->
                                            </button>
                                            <!--begin::Button-->
