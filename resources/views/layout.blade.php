...
<html lang="en">
    ...
    @if($user->role->name == 'controlleur')
	<div class="menu-item">
									<a class="menu-link" href="/dashboard" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img src="{{ auth()->user()->getFirstMediaUrl('photos')}}" alt="logo" width="100">
										</div>
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-30px me-5">
														...
														<img src="{{ asset(auth()->user()->photo) }}" alt="logo" width="100">
													...
													<div class="d-flex flex-column">
														...
														<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ $user->role->name }}
														</span>	
												    </div>
