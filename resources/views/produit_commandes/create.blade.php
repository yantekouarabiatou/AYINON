<!-- resources/views/produitsCommandes/create.blade.php -->
@extends('layout')
@section('content')
                ...
                <div id="kt_content_container" class="container-xxl">
                    <div class="card shadow-sm">
                        <div class="card-header pt-7">
                            <h5 class="card-title">Ajouter un produit commandé</h5>
                        </div>
                        <div class="card-body">
                            <!-- Formulaire pour créer un produit commandé -->
                            <form action="{{ route('produitsCommandes.store') }}" method="POST">
                                @csrf
                                <div class="row g-2">
