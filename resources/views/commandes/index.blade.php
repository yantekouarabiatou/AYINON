                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_commandes">
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commande->peremption_date }}</td>
                                             <!--begin::Action=-->
<td class="text-end">
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
		<li><a class="dropdown-item" href="{{ route('commandes.show', $commande->id) }}">
		  <i class="fas fa-eye pe-2"></i>Voir
		</a></li>
		<li><a class="dropdown-item" href="{{ route('commandes.edit', $commande->id) }}">
		  <i class="fas fa-edit pe-2"></i>Modifier
		</a></li>
		<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $commande->id }}">
