                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_produits">
                                        <thead>
                                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-175px">produit Image</th>
                                                <th class="min-w-175px">produit Name</th>
                                                <th class="min-w-150px">produit Description</th>
                                                <th class="min-w-150px">produit Price</th>
                                                <th class="min-w-175px">produit Quantity</th>
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($produit->photo)
													<img src="{{ Storage::url($produit->photo) }}" alt="{{ $produit->name }}" width="100" />
                                                    @else
                                                        <span>No image</span>
                                                    @endif
                                                </td>
...
<td class="text-end">
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
		<li><a class="dropdown-item" href="{{ route('produits.show', $produit->id) }}">
		  <i class="fas fa-eye pe-2"></i>Voir
		</a></li>
		<li><a class="dropdown-item" href="{{ route('produits.edit', $produit->id) }}">
		  <i class="fas fa-edit pe-2"></i>Modifier
		</a></li>
		<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $produit->id }}">
