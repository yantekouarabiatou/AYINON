                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0"
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-250px">Role assigné</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($permission->roles->isEmpty())
                                                            <span>Aucun rôle associé</span>
                                                        @else
                                                            @foreach ($permission->roles as $role)
                                                                @php
                                                                    // Définir la classe de couleur du badge en fonction du rôle
                                                                    $badgeClass = '';
                                                                    if ($role->name == 'Administrateur') {
                                                                        $badgeClass = 'badge-light-success';
                                                                    } elseif ($role->name == 'Gerant') {
                                                                ...
                                                                <a href="{{ route('roles.show', $role->id) }}"
                                                                    class="badge {{ $badgeClass }} fs-7 m-1">
                                                                    {{ $role->name }}
                                                                </a>
                                                            @endforeach
                                                        @endif
                                            ...
                                            <form id="kt_modal_add_permission_form" class="form" action="#">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <label class="form-check form-check-custom form-check-solid me-9">
                                                        ...
                                                        <span class="form-check-label" for="kt_permissions_core">Set as
                                                            core permission</span>
                                                    </label>
                                                    <!--end::Checkbox-->
                                                </div>
                                                <!--end::Input group-->
